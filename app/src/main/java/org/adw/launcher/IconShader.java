...
public class IconShader {
        ...
        try {
            ...
            while (eventType != XmlResourceParser.END_DOCUMENT) {
                if (eventType == XmlResourceParser.START_TAG
                    ...
                    a0 = xpp.getAttributeValue(null, "t");
                    a1 = xpp.getAttributeValue(null, "m");
                    a2 = xpp.getAttributeValue(null, "v");
    ...
    public static Bitmap processIcon(Bitmap icon_d, CompiledIconShader compiledShader) {
        ...
        int width = icon_d.getWidth();
        int height = icon_d.getHeight();
        ...
        // convert to float
        icon_d.getPixels(pixels, 0, width, 0, 0, width, height);
        ...
        // build drawable
        Bitmap.Config c = (icon_d.getConfig() == null) ?
                Bitmap.Config.ARGB_8888 : icon_d.getConfig();
